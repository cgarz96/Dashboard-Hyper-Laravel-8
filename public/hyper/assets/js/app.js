!function(i) {
    ...
    t.prototype._reset = function() {
        ...
        this._reset(), i(document).on("click", ".button-menu-mobile", function(t) {
            ...
            this.href == o && (i(this).addClass("active"), i(this).parent().addClass("menuitem-active"), 
        ...
        a.forEach(function(a) {
            a.addEventListener("click", function(t) {
                ...
                bootstrap.Dropdown.getInstance(e).show(), a.ariaExpanded ? bootstrap.Dropdown.getInstance(a).hide() : bootstrap.Dropdown.getInstance(e).show(), 
                o = !0);
                ...
                o || a.parentElement.classList.contains("nav-item") || (t.preventDefault(), t.stopPropagation(), 
                o = !0);
            });
        });
    ...
    t.prototype.initMenu = function() {
        a(".topnav-menu").length && (a(".topnav-menu li a").each(function() {
            ...
            this.href == t && (a(this).addClass("active"), a(this).parent().parent().addClass("active"), 
            a(this).parent().parent().parent().parent().addClass("active"), a(this).parent().parent().parent().parent().parent().parent().addClass("active"));
        ...
        a(document).on("click", function(t) {
            ...
            return t.preventDefault(), e.children(".dropdown-menu.show").removeClass("show"), 
    ...
    t.prototype._selectOptionsFromConfig = function() {
        ...
        if (t) {
            ...
            t.isScrollable || t.isCondensed || a("#fixed-check").prop("checked", !0), t.isDarkModeEnabled || (a("#light-mode-check").prop("checked", !0), 
    ...
    var e = "default", o = "light", i = "dark", n = {
        sideBarTheme: e,
        isBoxed: !1,
        isCondensed: !1,
        isScrollable: !1,
    ...
    t.prototype._saveConfig = function(t) {
        ...
        return t && (e.sideBarTheme = t.leftSideBarTheme, e.isBoxed = t.layoutBoxed, e.isCondensed = t.leftSidebarCondensed, 
        e.isScrollable = t.leftSidebarScrollable, e.isDarkModeEnabled = t.darkMode), e;
        ...
        t._config.isDarkModeEnabled ? t.activateDarkMode() : t.deactivateDarkMode(), t._config.isBoxed && t.activateBoxed(), 
        t._config.isCondensed && t.activateCondensedSidebar(), t._config.isScrollable && t.activateScrollableSidebar();
        ...
        var t = this;
        this.body.css("visibility", "hidden"), a("#light-style").attr("disabled", !0), a("#dark-style").removeAttr("disabled"), 
        setTimeout(function() {
            t.body.css("visibility", "visible");
        }, 500), "detached" === !this.body.attr("data-layout") ? (a.LeftSidebar.activateDarkTheme(), 
        this._saveConfig({
            isDarkModeEnabled: !0,
            sideBarTheme: i
        })) : this._saveConfig({
        ...
        var t = this;
        this.body.css("visibility", "hidden"), a("#dark-style").attr("disabled", !0), a("#light-style").removeAttr("disabled"), 
        setTimeout(function() {
            t.body.css("visibility", "visible");
        ...
        e.deactivateCondensedSidebar(), e.deactivateDarkMode(), e.activateDefaultSidebarTheme(), 
        e.activateFluid(), t();
    }, t.prototype.init = function() {
        var e = this;
        a("#main-style-container").length && (e.defaultSelectedStyle = a("#main-style-container").attr("href")), 
    ...
    "use strict";
    function t() {
        this.$body = i("body"), this.$portletIdentifier = ".card", this.$portletCloser = '.card a[data-bs-toggle="remove"]', 
    ...
    t.prototype.initSelect2 = function() {
        ...
        this.initSelect2(), this.initMask(), this.initDateRange(), this.initTimePicker(), 
        this.initTouchspin(), this.initMaxlength();
    ...
    t.prototype.initTooltipPlugin = function() {
        ...
        a(".needs-validation").on("submit", function(t) {
            return a(this).addClass("was-validated"), !1 !== a(this)[0].checkValidity() || (t.preventDefault(), 
            t.stopPropagation(), !1);
        });
        ...
        this.initTooltipPlugin(), this.initPopoverPlugin(), this.initToastPlugin(), this.initFormValidation(), 
        this.initShowHidePassword(), this.initMultiDropdown(), this.initSyntaxHighlight();
    ...
    t.prototype.activateDefaultSidebarTheme = function() {
        ...
        sessionStorage.setItem("_HYPER_VISITED_", !0))), a.Portlet.init(), a.AdvanceFormApp.init(), 
        a.Components.init(), a(window).on("load", function() {
